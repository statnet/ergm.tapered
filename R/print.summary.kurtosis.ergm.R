#' @rdname summary.kurtosis.ergm
#' @param x object of class `summary.kurtosis.ergm` returned by
#'   [summary.ergm()].
...
#' @export
print.summary.kurtosis.ergm <- function (x, 
  ...
  if(print.header){
    cat("\n============================\n")
    cat("Summary of Kurtosis ERGM fit\n")
    cat("============================\n\n")
  }
